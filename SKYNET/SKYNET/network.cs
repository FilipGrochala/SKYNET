...
namespace SKYNET
{
    class network
    {
        ...
        public struct neuron
        {
         ...
         int input_size = 0; //wielkość warstwy wejściowej i wyjściowej
         int output_size = 0;
        ...
        public  int number_of_iterrations = 2000;
       ...
       public List<double> error = new List<double>();
        ...
        //    } while (iterration < number_of_iterrations || err > good_enaugh);
        ...
        private void backpropagation() //wsteczna propagacja błędu 
        {
        ...
        private double calculate_error() //obliczanie błędu dla całej sieci 
        {
            double err = 0;
        ...
        private void get_output(string value, double[] signals)
